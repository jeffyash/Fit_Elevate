...
class MealCalendarWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final userMealInfo = Provider.of<MealCalorieTracker>(context);
    ...
    return TableCalendar(
      ...
      focusedDay: userMealInfo.selectedDate,
      selectedDayPredicate: (day) => userMealInfo.isSameDay(userMealInfo.selectedDate, day),
      onDaySelected: (selectedDay, focusedDay) {
        ...
        if (selectedDay.isBefore(currentDate) || selectedDay.isAtSameMomentAs(currentDate)) {
          userMealInfo.updateSelectedDate(selectedDay);
        } else {
          print('Selected date is in the future. Cannot track food intake.');
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('Selected date is in the future. Cannot track food intake.'),
